...
def build_interface(args: dict) -> gr.Blocks:
    ...
    try:
        ...
        visible_gr_group_custom_model = interface_component_options[
        ...
        with gr.Blocks(
            theme=theme, title=title, css=header_css, delete_cache=(604800, 86400)
        ) as app:
            with gr.Group(
                visible=True, elem_id="gr_group_main", elem_classes="gr-group-main"
            ) as gr_group_main:
                with gr.Tabs(elem_id="gr_tabs") as gr_tabs:
                    with gr.Tab(
                        "Dashboard", elem_id="gr_tab_main", elem_classes="gr-tab"
                    ) as gr_tab_main:
                        with gr.Row(elem_id="gr_row_tab_main"):
                            with gr.Column(
                                elem_id="gr_col_1", elem_classes=["gr-col"], scale=3
                            ):
                                with gr.Group(
                                    elem_id="gr_group_ebook_src",
                                    elem_classes=["gr-group"],
                                ):
                                    gr_import_markdown = gr.Markdown(
                                        elem_id="gr_import_markdown",
                                        elem_classes=["gr-markdown"],
                                        value="Import",
                                    )
                                    gr_ebook_src = gr.File(
                                        show_label=False,
                                        label="-",
                                        elem_id="gr_ebook_src",
                                        visible=True,
                                        file_types=ebook_formats,
                                        file_count=ebook_modes["SINGLE"],
                                        allow_reordering=True,
                                        height=100,
                                    )
                                    gr_voice_highlight_css = gr.HTML(
                                        value="",
                                        elem_classes=["gr-voice-highlight-css"],
                                    )
                                    gr_ebook_textarea = gr.Textbox(
                                        show_label=True,
                                        label="Text Prompt",
                                        elem_id="gr_ebook_textarea",
                                        visible=False,
                                        lines=8,
                                        max_length=max_ebook_textarea_length,
                                    )
                                    with gr.Row(
                                        elem_id="gr_row_ebook_mode"
                                    ) as gr_row_ebook_mode:
                                        gr_ebook_mode = gr.Dropdown(
                                            label="",
                                            elem_id="gr_ebook_mode",
                                            choices=[
                                                ("File", ebook_modes["SINGLE"]),
                                                ("Directory", ebook_modes["DIRECTORY"]),
                                                ("Text", ebook_modes["TEXT"]),
                                            ],
                                            interactive=True,
                                            scale=2,
                                        )
                                        gr_blocks_preview = gr.Checkbox(
                                            label="Chapters Preview",
                                            elem_id="gr_blocks_preview",
                                            value=False,
                                            interactive=True,
                                            scale=1,
                                        )
                                with gr.Group(
                                    elem_id="gr_group_language",
                                    elem_classes=["gr-group"],
                                ):
                                    gr_language_markdown = gr.Markdown(
                                        elem_id="gr_language_markdown",
                                        elem_classes=["gr-markdown"],
                                        value="Language",
                                    )
                                    with gr.Row(
                                        elem_id="gr_row_language"
                                    ) as gr_row_language:
                                        ...
                                        gr_translate_enabled = gr.Checkbox(
                                            label="Translate",
                                            elem_id="gr_translate_enabled",
                                            value=False,
                                            interactive=True,
                                            scale=1,
                                            min_width=120,
                                        )
                                        gr_translate = gr.Dropdown(
                                            show_label=False,
                                            elem_id="gr_translate",
                                            choices=[],
                                            value=None,
                                            type="value",
                                            interactive=True,
                                ...
                                gr_group_voice_file = gr.Group(
                                    elem_id="gr_group_voice_file",
                                    elem_classes=["gr-group"],
                                    visible=visible_gr_group_voice_file,
                                )
                                with gr_group_voice_file:
                                    gr_voice_markdown = gr.Markdown(
                                        elem_id="gr_voice_markdown",
                                        elem_classes=["gr-markdown"],
                                        value="Voices",
                                    )
                                    ...
                                    with gr.Row(
                                        elem_id="gr_row_voice_player"
                                    ) as gr_row_voice_player:
                                        gr_voice_player_hidden = gr.Audio(
                                            elem_id="gr_voice_player_hidden",
                                            type="filepath",
                                            interactive=False,
                                        ...
                                        gr_voice_play = gr.Button(
                                            "▶",
                                            elem_id="gr_voice_play",
                                        ...
                                        gr_voice_selected_filename = gr.Markdown(
                                            value="",
                                            elem_id="gr_voice_selected_filename",
                                            elem_classes=["gr-markdown"],
                                            visible=False,
                                        )
                                ...
                                with gr.Group(
                                    elem_id="gr_group_device", elem_classes=["gr-group"]
                                ):
                                    gr_device_markdown = gr.Markdown(
                                        elem_id="gr_device_markdown",
                                        elem_classes=["gr-markdown"],
                                        value="Processor",
                                    )
                                    gr_device = gr.Dropdown(
                                        label="",
                                        elem_id="gr_device",
                                        choices=[
                                            (k, v["proc"]) for k, v in devices.items()
                                        ],
                                        type="value",
                            ...
                            with gr.Column(
                                elem_id="gr_col_2", elem_classes=["gr-col"], scale=3
                            ):
                                with gr.Group(
                                    elem_id="gr_group_tts_engine",
                                    elem_classes=["gr-group"],
                                ):
                                    gr_tts_rating = gr.Markdown(
                                        elem_id="gr_tts_rating",
                                        elem_classes=["gr-markdown"],
                                        value="TTS Engine",
                                    )
                                ...
                                with gr.Group(
                                    elem_id="gr_group_models", elem_classes=["gr-group"]
                                ):
                                    gr_models_markdown = gr.Markdown(
                                        elem_id="gr_models_markdown",
                                        elem_classes=["gr-markdown"],
                                        value="Models",
                                    )
                                    gr_fine_tuned_list = gr.Dropdown(
                                        label="Fine Tuned Preset Models",
                                    ...
                                    with gr_group_custom_model:
                                        gr_custom_model_file = gr.File(
                                            show_label=True,
                                            label=f"Upload a ZIP File",
                                            elem_id="gr_custom_model_file",
                                            value=None,
                                            file_types=[".zip"],
                                            height=100,
                                        )
                                        gr_row_custom_model_list = gr.Row(
                                            elem_id="gr_row_custom_model_list"
                                        )
                                        with gr_row_custom_model_list:
                                            ...
                                            gr_custom_model_train_link = gr.Markdown(
                                                value='<a href="https://huggingface.co/spaces/drewThomasson/xtts-finetune-webui-gpu" target="_blank" rel="noopener noreferrer">Create My Own Model</a>',
                                                elem_id="gr_custom_model_train_link",
                                                elem_classes=["gr-markdown"],
                                                visible=True,
                                            )
                                ...
                                with gr.Group(elem_id="gr_group_output_format"):
                                    gr_output_markdown = gr.Markdown(
                                        elem_id="gr_output_markdown",
                                        elem_classes=["gr-markdown"],
                                        value="Output",
                                    )
                                    with gr.Row(elem_id="gr_row_output_format"):
                                        ...
                                        gr_output_channel_list = gr.Dropdown(
                                            label="Channel",
                                            elem_id="gr_output_channel_list",
                                            choices=["mono", "stereo"],
                                            type="value",
                                            value=default_output_channel,
                                            interactive=True,
                                            scale=1,
                                        )
                                        with gr.Group(elem_id="gr_group_output_split"):
                                            gr_output_split = gr.Checkbox(
                                                label="Split File",
                                                elem_id="gr_output_split",
                                                value=default_output_split,
                                                interactive=True,
                                            )
                                            gr_output_chapter_mode = gr.Checkbox(
                                                label="Per Chapter",
                                                elem_id="gr_output_chapter_mode",
                                                value=default_output_chapter_mode,
                                                interactive=True,
                                            )
                                            gr_output_overwrite = gr.Checkbox(
                                                label="Overwrite",
                                                elem_id="gr_output_overwrite",
                                                value=default_output_overwrite,
                                                interactive=True,
                                            )
                                            gr_row_output_split_hours = gr.Row(
                                                elem_id="gr_row_output_split_hours",
                                                visible=False,
                                            )
                                            with gr_row_output_split_hours:
                                                gr_output_split_hours_markdown = gr.Markdown(
                                                    elem_id="gr_output_split_hours_markdown",
                                                    elem_classes=[
                                                        "gr-markdown-output-split-hours"
                                                    ],
                                                    value="Hours<br/>/ Part",
                                                )
                                                gr_output_split_hours = gr.Dropdown(
                                                    label="",
                                                    elem_id="gr_output_split_hours",
                                                    choices=options_output_split_hours,
                                                    type="value",
                                                    value=default_output_split_hours,
                                                    interactive=True,
                                                    scale=1,
                                                )
                                with gr.Accordion(
                                    label="Audiobookshelf",
                                    elem_id="gr_accordion_abs",
                                    open=False,
                                ):
                                    gr_abs_enabled = gr.Checkbox(
                                        label="Upload to Audiobookshelf",
                                        elem_id="gr_abs_enabled",
                                        value=default_abs_enabled,
                                        interactive=True,
                                    )
                                    ...
                                    gr_abs_api_token = gr.Textbox(
                                        label="API Token",
                                        elem_id="gr_abs_api_token",
                                        type="password",
                                        placeholder="eyJ...",
                                ...
                                with gr.Group(
                                    ...
                                    gr_session_markdown = gr.Markdown(
                                        elem_id="gr_session_markdown",
                                        elem_classes=["gr-markdown"],
                                        value="Session",
                                    )
                                    ...
                                    with gr.Row(elem_id="gr_row_session"):
                                        gr_session = gr.Textbox(
                                            label="",
                                            elem_id="gr_session",
                                            interactive=False,
                                        )
                                        gr_session_switch_btn = gr.Button(
                                            "🔒︎",
                                            elem_id="gr_session_switch_btn",
                                            elem_classes=["small-btn-lock"],
                                            variant="secondary",
                                            visible=True,
                                            interactive=True,
                                            scale=0,
                    ...
                    with gr.Tab(
                        "XTTS Settings",
                        elem_id="gr_tab_xtts_params",
                        elem_classes="gr-tab",
                        visible=False,
                    ) as gr_tab_xtts_params:
                        with gr.Group(
                            elem_id="gr_group_xtts_params", elem_classes=["gr-group"]
                        ):
                            gr_xtts_temperature = gr.Slider(
                                ...
                                step=0.05,
                                value=float(
                                    default_engine_settings[TTS_ENGINES["XTTS"]][
                                        "temperature"
                                    ]
                                ),
                            ...
                            gr_xtts_enable_text_splitting = gr.Checkbox(
                                ...
                                value=default_engine_settings[TTS_ENGINES["XTTS"]][
                    ...
                    with gr.Tab(
                        "Bark Settings",
                        elem_id="gr_tab_bark_params",
                        elem_classes="gr-tab",
                        visible=False,
                    ) as gr_tab_bark_params:
                        gr.Markdown(
                        ...
                        with gr.Group(
                            elem_id="gr_group_bark_params", elem_classes=["gr-group"]
                        ):
                            gr_bark_text_temp = gr.Slider(
                                ...
                                step=0.01,
                                value=float(
                                    default_engine_settings[TTS_ENGINES["BARK"]][
                                        "text_temp"
                                    ]
                                ),
                    ...
                    with gr.Tab(
                        "Qwen3 Settings",
                        elem_id="gr_tab_qwen3_params",
                        elem_classes="gr-tab",
                        visible=False,
                    ) as gr_tab_qwen3_params:
                        gr.Markdown(
                        ...
                        with gr.Group(
                            elem_id="gr_group_qwen3_params", elem_classes=["gr-group"]
                        ):
                ...
                with gr.Group(
                    elem_id="gr_group_progress", elem_classes=["gr-group-sides-padded"]
                ):
                    gr_progress_markdown = gr.Markdown(
                        elem_id="gr_progress_markdown",
                        elem_classes=["gr-markdown"],
                        value="Status",
                    )
                    gr_progress = gr.Textbox(
                        elem_id="gr_progress", label="", interactive=False, visible=True
                    )
                    gr_progress_bar = gr.Progress(track_tqdm=True)

                with gr.Group(
                    elem_id="gr_group_audiobook_list",
                    elem_classes=["gr-group-sides-padded"],
                    visible=True,
                ) as gr_group_audiobook_list:
                    gr_audiobook_markdown = gr.Markdown(
                        elem_id="gr_audiobook_markdown",
                        elem_classes=["gr-markdown"],
                        value="Audiobook",
                    )
                    gr_audiobook_vtt = gr.Textbox(
                        elem_id="gr_audiobook_vtt",
                        label="",
                        interactive=False,
                        visible="hidden",
                    )
                    gr_playback_time = gr.Number(
                        elem_id="gr_playback_time",
                        label="",
                        interactive=False,
                        visible="hidden",
                        value=0.0,
                    )
                    gr_audiobook_sentence = gr.Textbox(
                        elem_id="gr_audiobook_sentence",
                        label="",
                        value="…",
                        interactive=False,
                        lines=3,
                    ...
                    with gr.Row(
                        elem_id="gr_row_audiobook_list", visible=True
                    ) as gr_row_audiobook_list:
                        gr_audiobook_download_btn = gr.Button(
                    ...
                    gr_audiobook_files = gr.Files(
                        label="", elem_id="gr_audiobook_files", visible=False
                    )
                    gr_audiobook_files_state = gr.State(False)
                with gr.Group(
                    elem_id="gr_group_convert_btn",
                    elem_classes=["gr-group-convert-btn"],
                ) as gr_group_convert_btn:
                    gr_convert_btn = gr.Button(
                        elem_id="gr_convert_btn",
                        value="📚",
                        elem_classes="gr-convert-btn",
                        variant="primary",
                        interactive=False,
                    )
            ...
            with gr.Group(
                visible=False, elem_id="gr_group_blocks", elem_classes="gr-group-main"
            ) as gr_group_blocks:
                gr_blocks_markdown = gr.Markdown(
                    elem_id="gr_blocks_markdown", elem_classes=["gr-markdown"], value=""
                )
                with gr.Row(elem_id="gr_blocks_nav") as gr_blocks_nav:
                    gr_blocks_back_btn = gr.Button(
                        "◀", elem_id="gr_blocks_back_btn", interactive=False, scale=1
                    )
                    gr_blocks_header = gr.Markdown("", elem_id="gr_blocks_header")
                    gr_blocks_next_btn = gr.Button(
                        "▶", elem_id="gr_blocks_next_btn", interactive=False, scale=1
                    )
                ...
                with gr.Column(elem_id="gr_column_blocks", elem_classes=["gr-col"]):
                    for i in range(page_size):
                        ...
                        with gr.Accordion(
                            ...
                            with gr.Row(
                                elem_id=f"block_options_row_{i}",
                                elem_classes=[acc_class, "no-wrap"],
                            ) as block_options_row:
                            ...
                            acc_reset_btn.click(
                                fn=lambda session, _i=i: _click_reset_block(
                                    session, _i
                                ),
                                inputs=[gr_session],
                                outputs=[acc_text],
                        ...
                        block_components.append(
                            (acc, acc_keep, acc_voice_list, acc_text)
                        )

                with gr.Row(elem_id="gr_row_buttons", visible=True) as gr_row_buttons:
                    gr_blocks_cancel_btn = gr.Button(
                        "🡄",
                        elem_classes=["gr-blocks-buttons"],
                        variant="stop",
                        scale=0,
                        size="md",
                    )
                    gr_blocks_confirm_btn = gr.Button(
                        "🡆",
                        elem_classes=["gr-blocks-buttons"],
                        variant="primary",
                        scale=0,
            ...
            blocks_components_flat = [
                comp for quad in block_components for comp in quad
            ]
            ...
            gr_version_markdown = gr.Markdown(
                elem_id="gr_version_markdown",
                value=f"""
            ...
            gr_glassmask = gr.HTML(
                gr_glassmask_msg, elem_id="gr_glassmask", elem_classes=["gr-glass-mask"]
            )
            gr_data_field_hidden = gr.Textbox(
                elem_id="gr_data_field_hidden", visible=False
            )

            gr_deletion_cancel_btn = gr.Button(
                elem_id="gr_deletion_cancel_btn",
                elem_classes=["hide-elem"],
                value="🡄",
                variant="stop",
                visible=True,
                scale=0,
            ...
            gr_deletion_confirm_btn = gr.Button(
                elem_id="gr_deletion_confirm_btn",
                elem_classes=["hide-elem"],
                value="🡆",
                variant="primary",
                visible=True,
            ...
            gr_override_cancel_btn = gr.Button(
                elem_id="gr_override_cancel_btn",
                elem_classes=["hide-elem"],
                value="🡄",
                variant="stop",
                visible=True,
            ...
            gr_override_confirm_btn = gr.Button(
                elem_id="gr_override_confirm_btn",
                elem_classes=["hide-elem"],
                value="🡆",
                variant="primary",
                visible=True,
            ...
            def _disable_components(
                ...
                if session_id is None:
                    ...
                    if "gr_session_switch_btn" in exceptions:
                        outputs = tuple(
                            gr.update(interactive=False) for _ in range(n - 1)
                        ) + (gr.update(interactive=True),)
                    else:
                        outputs = tuple(gr.update(interactive=False) for _ in range(n))
                return outputs
                    ...
                    if session and session.get("id", False):
                        if session["status"] in [
                            ...
                            return tuple(outputs) + (
                                gr.update(
                                    interactive=True,
                                    visible=visible_custom_model_del_btn,
                                ),
                                gr.update(value=""),
            ...
            def _enable_on_voice_upload(session_id: str) -> tuple:
                ...
                if session and session.get("id", False):
                    enabled_convert_btn = (
                        True if session["ebook"] is not None else enabled_convert_btn
                    )
                    visible_buttons = (
                        True if session["voice"] is not None else visible_buttons
                    )
                return outputs + (
                    gr.update(interactive=enabled_convert_btn),
            ...
            def _enable_on_custom_upload(
                custom_model: str | None, ebook_data: any, ebook_textarea: any
            ) -> tuple:
                ...
                visible_custom_model_del_btn = (
                    True if custom_model is not None else False
                )
                return outputs + (
                    gr.update(interactive=enabled_convert_btn),
            ...
            def _yellow_stars(n: int):
                return "".join(
                    "<span style='color:#f0bc00; font-size:12px'>★</span>"
                    for _ in range(n)
                )
            ...
            def _is_valid_gradio_cache(path):
                ...
                return (
                    parent.startswith(gradio_cache_dir)
                    and len(os.path.basename(parent)) >= 32
                )
            ...
            def _restore_interface(session_id: str, req: gr.Request) -> tuple:
                try:
                    ...
                    if session and session.get("id", False):
                        ...
                        if session.get("ebook_mode") == ebook_modes["TEXT"]:
                            ...
                            if session.get("ebook_list", None) is not None:
                                if len(session["ebook_list"]) > 0:
                                    ebook_data = [
                                        f
                                        for f in session["ebook_list"]
                                        if _is_valid_gradio_cache(f)
                                    ]
                                if ebook_data:
                                    enabled_convert_btn = True
                                else:
                            ...
                            if ebook_data:
                                enabled_convert_btn = True
                            visible_ebook_src = True
                        visible_row_split_hours = (
                            True if session["output_split"] else False
                        )
                        visible_group_custom_model = (
                            visible_gr_group_custom_model
                            if session["fine_tuned"] == "internal"
                            and session["tts_engine"] in tts_engines_with_custom_model
                            else False
                        )
                        visible_qwen3 = (
                            visible_gr_tab_qwen3_params
                            if session["tts_engine"] == TTS_ENGINES["QWEN3TTS"]
                            else False
                        )
                        visible_voice_buttons = (
                            True if session.get("voice") is not None else False
                        )
                        visible_custom_model_del_btn = (
                            True if session["custom_model"] is not None else False
                        )
                        ...
                        translate_options = (
                            _build_translate_targets(language) if language else []
                        )
                        translate_codes = {o[1] for o in translate_options}
                        if translate not in translate_codes:
                            translate = (
                                translate_options[0][1] if translate_options else None
                            )
                        ...
                        translate_visible = translate_enabled_state and bool(
                            translate_options
                        )
                        return (
                            gr.update(
                                visible=visible_ebook_src,
                                value=ebook_data,
                                file_count=ebook_file_count,
                            ),
                            gr.update(
                                visible=visible_ebook_textarea, value=ebook_textarea
                            ),
                            ...
                            gr.update(
                                visible=translate_visible,
                                choices=translate_options,
                                value=translate,
                            ),
                            ...
                            gr.update(
                                value=bool(session.get("output_chapter_mode", False))
                            ),
                            gr.update(
                                value=bool(session.get("output_overwrite", False))
                            ),
                            ...
                            gr.update(visible=visible_voice_buttons),
                            gr.update(
                                label=f"Upload a {session['tts_engine'].upper()} ZIP file (Required: {', '.join(models[default_fine_tuned]['files'])})"
                            ),
                            gr.update(visible=visible_custom_model_del_btn),
            ...
            def _restore_audiobook_player(
                session_id: str, audiobook: str | None
            ) -> tuple:
                try:
                    visible = True if audiobook is not None else False
                    return (
                        gr.update(visible=visible),
                        gr.update(value=audiobook),
                    ...
                    if session and session.get("id", False):
                        ...
                        if session["status"] in [
                            ...
                            return (
                                ...
                                gr.update(),
                                gr.update(),
                                gr.update(visible=True, value=session["ebook_list"]),
                                gr.update(),
                                gr.update(),
                                gr.update(),
                                gr.update(),
            ...
            def _change_gr_audiobook_list(
                session_id: str, selected: str | None
            ) -> dict:
                try:
                    session = context.get_session(session_id)
                    if session and session.get("id", False):
                    ...
                    if session and session.get("id", False):
                        if session["audiobook"] is not None:
                            ...
                            if not os.path.exists(
                                session["audiobook"]
                            ) or not os.path.exists(vtt):
                                error = (
                                    f"{Path(session['audiobook']).name} does not exist!"
                                )
                                exception_alert(session_id, error)
                                return (
                                    gr.update(value=0.0),
                            ...
                            if duration:
                                ...
                                with open(
                                    vtt, "r", encoding="utf-8-sig", errors="replace"
                                ) as f:
                                    vtt_content = f.read()
                                return (
                                    gr.update(value=0.0),
                                    gr.update(value=session["audiobook"]),
                                    gr.update(value=vtt_content),
                                )
                            else:
            ...
            def _update_gr_glassmask(
                str: str = gr_glassmask_msg, attr: list = ["gr-glass-mask"]
            ) -> dict:
            ...
            def _change_gr_ebook_src(
                session_id: str, ebook_mode: str, data: any
            ) -> tuple:
                try:
                    session = context.get_session(session_id)
                    if session and session.get("id", False):
                        if (
                            session.get("ebook_src") == data
                            and ebook_mode == ebook_modes["SINGLE"]
                        ) or (
                            session.get("ebook_list") == data
                            and ebook_mode == ebook_modes["DIRECTORY"]
                        ):
                            return (
                                gr.update(),
                                gr.update(),
                        ...
                        if ebook_mode == ebook_modes["SINGLE"]:
                            ...
                            new_map = {
                                p: (prev_map[p] if p in prev_map else default_voice)
                                for p in abs_files
                            }
                            ...
                            if prev_selected and prev_selected in abs_files:
                                ...
                                return (
                                    gr.update(),
                                    gr.update(
                                        value=_build_voice_highlight_css(new_row)
                                    ),
                                    gr.update(),
                                    gr.update(visible=True),
                                    gr.update(
                                        value=Path(prev_selected).name, visible=True
                                    ),
                                    gr.update(),
                                )
                            else:
                                session["ebook_selected"] = None
                                voice_update = (
                                    gr.update(value=session.get("voice"))
                                    if prev_selected
                                    else gr.update()
                                )
                                if data is None and session.get("status", None) in [
                                    status_tags["EDIT"],
                                    status_tags["CONVERTING"],
                                ]:
                                    session["cancellation_requested"] = True
                                    msg = "Cancellation requested, please wait…"
                                    return (
                                        gr.update(
                                            value=_show_gr_modal("wait", msg),
                                            visible=True,
                                        ),
                                        gr.update(value=""),
                                        voice_update,
                        ...
                        if data is None:
                            if session.get("status", None) in [
                                ...
                                return (
                                    gr.update(
                                        value=_show_gr_modal("wait", msg), visible=True
                                    ),
                                    gr.update(value=""),
                                    gr.update(),
                                    gr.update(),
            ...
            def _select_gr_ebook_src(
                ...
                try:
                    ...
                    live_list = (
                        ebook_src if isinstance(ebook_src, list) and ebook_src else None
                    )
                    ebook_list = (
                        live_list
                        if live_list is not None
                        else (session.get("ebook_list") or [])
                    )
                    if (
                        not isinstance(ebook_list, list)
                        or row < 0
                        or row >= len(ebook_list)
                    ):
                        return (
                            gr.update(),
                            gr.update(value=""),
                    ...
                    assigned_voice = (
                        voice_map[abs_path]
                        if abs_path in voice_map
                        else session.get("voice")
                    )
            ...
            def _change_gr_ebook_mode(session_id: str, val: str) -> tuple:
                try:
                    ...
                    if session and session.get("id", False):
                        ...
                        if val == ebook_modes["DIRECTORY"] and session.get(
                            "ebook_selected"
                        ):
                            filename_update = gr.update(
                                value=Path(session["ebook_selected"]).name, visible=True
                            )
                        else:
                        ...
                        if val == ebook_modes["SINGLE"]:
                            ...
                            return (
                                gr.update(
                                    visible=True,
                                    label="-",
                                    file_count=ebook_modes["DIRECTORY"],
                                    value=session["ebook_list"],
                                ),
                                gr.update(visible=False),
                                gr.update(interactive=enabled_convert_btn),
                                css_update,
                            ...
                            return (
                                gr.update(visible=False),
                                gr.update(
                                    visible=True, value=session["ebook_textarea"]
                                ),
                                gr.update(interactive=True),
                                css_update,
                                gr.update(visible=row_visible),
                ...
                try:
                    ...
                    if f is not None:
                        if len(voice_options) > max_custom_voices:
                            ...
                            session = context.get_session(session_id)
                            if session and session.get("id", False):
                                voice_name = os.path.splitext(os.path.basename(f))[
                                    0
                                ].replace("&", "And")
                                ...
                                if status:
                                    ...
                                    error = (
                                        "failed! Check if you audio file is compatible."
                                    )
                                    state["type"] = "warning"
                                    state["msg"] = error
                        show_alert(session_id, state)
            ...
            def _change_gr_voice_list(session_id: str, selected: str | None) -> tuple:
                try:
                    ...
                    if session and session.get("id", False):
                        ...
                        if session.get("ebook_mode") == ebook_modes[
                            "DIRECTORY"
                        ] and session.get("ebook_selected"):
                    ...
                    if selected is not None:
                        ...
                        if session and session.get("id", False):
                            ...
                            if is_builtin and is_in_builtin:
                                ...
                                show_alert(
                                    session_id, {"type": "warning", "msg": error}
                                )
                            ...
                            try:
                                ...
                                error = (
                                    f"Could not delete the voice file {selected}!\n{e}"
                                )
                                exception_alert(session_id, error)
                                return gr.update(visible=False), gr.update()
                    return gr.update(visible=False), gr.update()
                ...
                try:
                    if selected is not None:
                        ...
                        if session and session.get("id", False):
                            ...
                            return gr.update(
                                value=_show_gr_modal(session["status"], msg),
                                visible=True,
                            ), gr.update(value="confirm_custom_model_del")
                except Exception as e:
                    ...
                    if selected is not None:
                        ...
                        if session and session.get("id", False):
                            ...
                            return gr.update(
                                value=_show_gr_modal(session["status"], msg),
                                visible=True,
                            ), gr.update(value="confirm_audiobook_del")
                except Exception as e:
                    error = f"Could not delete the audiobook {selected_name}!"
                    exception_alert(session_id, error)
                return gr.update(visible=False), gr.update()

            def _click_gr_deletion(
                session_id: str,
                voice_path: str,
                custom_model: str,
                audiobook: str,
                            ...
                            if session["status"] == status_tags["DELETION"]:
                                ...
                                if method == "confirm_voice_del":
                                    ...
                                    fallback = (
                                        ...
                                        in tts_engines_with_inner_speaker
                                        else default_engine_settings[
                                            session["tts_engine"]
                                        ]["voice"]
                                    )
                                    ...
                                    base_selected_name = re.sub(
                                        r"_part\d+$", "", selected_name
                                    )
                                    count_files = sum(
                                        1
                                        for f, _ in audiobook_options
                                        if re.sub(r"_part\d+$", "", Path(f).stem)
                                        == base_selected_name
                                    )
                ...
                try:
                    ...
                    if session and session.get("id", False):
                        ...
                        language = (
                            ...
                            and session["translate"] is not None
                            else session["language"]
                        )
                        lang_dir = (
                            language if language != "con" else "con-"
                        ...
                        if language in default_engine_settings[TTS_ENGINES["XTTS"]].get(
                            "languages", {}
                        ):
                        ...
                        if session["tts_engine"] == TTS_ENGINES["BARK"]:
                            ...
                            if lang_dict:
                                ...
                                bark_options = [
                                    ...
                                    for f in speakers_path.rglob(
                                        f"{lang}_speaker_*.npz"
                                    )
                                ]
                        elif session["tts_engine"] == TTS_ENGINES["PIPER"]:
                            engine_config = default_engine_settings[
                                TTS_ENGINES["PIPER"]
                            ]
                            lang_piper = engine_config["languages"][
                                language
                            ]  # e.g., "en_GB"
                        ...
                        voice_options = (
                            builtin_options + eng_options + bark_options + piper_options
                        )
                        ...
                        if session.get("custom_model_dir"):
                            voice_options.extend(
                                (f.stem, str(f))
                                for f in Path(session["custom_model_dir"]).rglob(
                                    "*.wav"
                                )
                                if f.is_file()
                            )
                        if session["tts_engine"] in tts_engines_with_inner_speaker:
                            voice_options = [("Default", None)] + sorted(
                                voice_options, key=lambda x: x[0].lower()
                            )
                        else:
                            voice_options = sorted(
                                voice_options, key=lambda x: x[0].lower()
                            )
                        if session["voice"] is not None and isinstance(
                            session.get("voice"), str
                        ):
                            if session["voice_dir"] not in session["voice"]:
                                if not any(
                                    v[1] == session["voice"] for v in voice_options
                                ):
                                    ...
                                    if "voices" in parts:
                                        ...
                                        if idx + 1 < len(parts):
                                            ...
                                            if os.path.exists(new_voice_path) and any(
                                                v[1] == new_voice_path
                            ...
                            if voice_options and voice_options[0][1] is not None:
                                new_voice_path = models[session["fine_tuned"]].get(
                                    "voice"
                                )
                                if (
                                    new_voice_path
                                    and os.path.exists(new_voice_path)
                                    and any(
                                        v[1] == new_voice_path for v in voice_options
                                    )
                                ):
                                    session["voice"] = new_voice_path
                                else:
            ...
            def _update_gr_translate_list(session_id: str) -> dict:
                ...
                if translate_options:
                    ...
                    translate_options.sort(
                        key=lambda item: lang_order.get(item[1], len(language_options))
                    )
                    if not translate or not any(
                        translate == val for _, val in translate_options
                    ):
                ...
                visible_gr_translate = (
                    True if session.get("translate_enabled") else False
                )
                return gr.update(
                    visible=visible_gr_translate,
                    choices=translate_options,
                    value=translate,
                )
            ...
            def _update_gr_tts_engine_list(session_id: str) -> dict:
                try:
                    ...
                    if session and session.get("id", False):
                        ...
                        if session.get("translate_enabled") and session.get(
                            "translate"
                        ):
                        ...
                        return gr.update(
                            choices=tts_engine_options, value=session["tts_engine"]
                        )
                except Exception as e:
            ...
            def _update_gr_custom_model_list(session_id: str) -> dict:
                try:
                    ...
                    session = context.get_session(session_id)
                    if session and session.get("id", False):
                        custom_model_tts_dir = _check_custom_model_tts(
                            session["custom_model_dir"], session["tts_engine"]
                        )
                        custom_model_options = [("None", None)] + [
                            (str(dir), os.path.join(custom_model_tts_dir, dir))
                        ...
                        session["custom_model"] = (
                            ...
                            in [option[1] for option in custom_model_options]
                            else custom_model_options[0][1]
                        )
                        model_paths = {v[1] for v in custom_model_options}
                        return gr.update(
                            choices=custom_model_options, value=session["custom_model"]
                        )
                except Exception as e:
            ...
            def _update_gr_fine_tuned_list(session_id: str) -> dict:
                try:
                    ...
                    if session and session.get("id", False):
                        ...
                        return gr.update(
                            choices=fine_tuned_options, value=session["fine_tuned"]
                        )
                except Exception as e:
            ...
            def _check_custom_model_tts(
                custom_model_dir: str, tts_engine: str
            ) -> str | None:
                dir_path = None
            ...
            def _change_gr_custom_model_file(
                session_id: str, custom_file: str | None, tts_engine: str
            ) -> tuple:
                try:
                    nonlocal models
                        ...
                        if len(custom_model_options) > max_custom_model:
                            ...
                            if session and session.get("id", False):
                                ...
                                if analyze_uploaded_file(
                                    custom_file, models["internal"]["files"]
                                ):
                                    ...
                                    if model is not None:
                                        ...
                                        if (
                                            session["tts_engine"]
                                            not in tts_engines_with_inner_speaker
                                        ):
                                            session["voice"] = os.path.join(
                                                model,
                                                f"{os.path.basename(os.path.normpath(model))}.wav",
                                            )
            ...
            def _change_gr_custom_model_list(
                session_id: str, selected: str | None
            ) -> tuple:
                try:
                    session = context.get_session(session_id)
                    if session and session.get("id", False):
                        ...
                        if (
                            ...
                            and session["tts_engine"]
                            not in tts_engines_with_inner_speaker
                        ):
                            session["voice"] = os.path.join(
                                selected, f"{os.path.basename(selected)}.wav"
                            )
                        visible_fine_tuned = (
                            True if session["custom_model"] is None else False
                        )
                        visible_del_btn = (
                            True if session["custom_model"] is not None else False
                        )
                        return (
                            gr.update(visible=visible_fine_tuned),
                            _update_gr_voice_list(session_id),
                            gr.update(visible=visible_del_btn),
                        )
                except Exception as e:
            ...
            def _change_gr_tts_engine_list(session_id: str, engine: str) -> tuple:
                try:
                    ...
                    session = context.get_session(session_id)
                    if session and session.get("id", False):
                        if session.get("tts_engine") != engine or session.get(
                            "translate_enabled"
                        ):
                            ...
                            session["voice"] = (
                                None
                                if session["voice"]
                                == default_engine_settings[session["tts_engine"]][
                                    "voice"
                                ]
                                else session["voice"]
                            )
                            ...
                            visible_xtts = (
                                visible_gr_tab_xtts_params
                                if session["tts_engine"] == TTS_ENGINES["XTTS"]
                                else False
                            )
                            visible_bark = (
                                visible_gr_tab_bark_params
                                if session["tts_engine"] == TTS_ENGINES["BARK"]
                                else False
                            )
                            visible_qwen3 = (
                            ...
                            supports_custom = (
                                session["tts_engine"] in tts_engines_with_custom_model
                            )
                            visible_custom_model = (
                                supports_custom and session["fine_tuned"] == "internal"
                            )
                            if supports_custom:
                                file_label = f"Upload a {session['tts_engine'].upper()} ZIP file (Required: {', '.join(models[default_fine_tuned]['files'])})"
                                custom_model_list_update = _update_gr_custom_model_list(
                                    session_id
                                )
                            else:
                            ...
                            if session.get("fine_tuned") != selected:
                                ...
                                if selected == "internal":
                                    visible_custom_model = (
                                        ...
                                        if session["fine_tuned"] == "internal"
                                        and session["tts_engine"]
                                        in tts_engines_with_custom_model
                                        else False
                                    )
                                else:
                                    visible_custom_model = False
                                    session["voice"] = models[session["fine_tuned"]][
                                        "voice"
                                    ]
                        ...
                        if session["status"] == status_tags["READY"]:
                            ...
                            if os.path.exists(new_session_dir) or new_session:
                                ...
                                return (
                                    gr.update(
                                        value=json.dumps(
                                            new_session, cls=JSONDictProxyEncoder
                                        )
                                    ),
                                    gr.update(interactive=False),
                                    None,
            ...
            def _change_param(
                key: str, session_id: str, val: Any, val2: Any = None
            ) -> None:
                try:
                    session = context.get_session(session_id)
                    if session and session.get("id", False):
            ...
            def _start_conversion(
                ...
                device: str,
                ebook_mode: str,
                ebook_src: str | list | None,
                ebook_textarea: str | None,
                blocks_preview: bool,
                tts_engine: str,
                language: str,
                voice: str,
                ...
                try:
                    ...
                    if session and session.get("id", False):
                        args = {
                            ...
                            "ebook_src": ebook_src
                            if ebook_mode == ebook_modes["SINGLE"]
                            else session["ebook_src"],
                            "ebook_list": ebook_src
                            if ebook_mode == ebook_modes["DIRECTORY"]
                            else session["ebook_list"],
                            "ebook_textarea": ebook_textarea
                            if ebook_mode == ebook_modes["TEXT"]
                            else session["ebook_textarea"],
                            "voice": voice,
                            "language": language,
                                    ...
                                    if isinstance(args["ebook_list"], list):
                                        ...
                                        while queue:
                                            ...
                                            if (
                                                ...
                                                show_alert(
                                                    session_id,
                                                    {"type": "warning", "msg": msg},
                                                )
                                                override = default_voice
                                            args["voice"] = override
                                            progress_status, passed = convert_ebook(
                                                args
                                            )
                                            if passed:
                        ...
                        if error is not None:
                            ...
                            if (
                                ...
                                and session["status"] == status_tags["DISCONNECTED"]
                            ):
                                context_tracker.end_session(
                                    session_id, session["socket_hash"]
                                )
                                return gr.update()
                    ...
                    if session and session.get("id", False):
                        ...
                        if len(audiobook_options) > 0:
                            ...
                            session["audiobook"] = (
                                ...
                                in [option[1] for option in audiobook_options]
                                else None
                            )
                            ...
                            session["audiobook"] = None
                        return gr.update(
                            choices=audiobook_options, value=session["audiobook"]
                        )
                except Exception as e:
                                    ...
                                    if source is not None:
                                        if ebook_mode == ebook_modes["TEXT"]:
                                            ...
                                            final_file = os.path.join(
                                                session["audiobooks_dir"], final_name
                                            )
                                            audio_sentences_exist = False
                                            if os.path.exists(sentences_dir):
                                                audio_sentences_exist = any(
                                                    Path(sentences_dir).rglob(
                                                        f"*.{default_audio_proc_format}"
                                                    )
                                                )
                                            if (
                                                os.path.exists(pre_file)
                                                or audio_sentences_exist
                                            ):
                                                session["status"] = status_tags[
                                                    "OVERRIDE"
                                                ]
                                                session["audiobook_overridden"] = (
                                                    final_file
                                                )
            ...
            def _click_gr_override_confirm_btn(
                session_id: str, event: int, audiobook_files_state: bool
            ) -> tuple:
                try:
                    session = context.get_session(session_id)
                    if session and session.get("id", False):
                        ...
                        if file_converting:
                            idx = next(
                                (
                                    i
                                    for i, t in enumerate(audiobook_options)
                                    if t[1] == file_converting
                                ),
                                -1,
                            )
                            new_list = [
                                t for t in audiobook_options if t[1] != file_converting
                            ]
                            if (
                                session["audiobook"] == file_converting
                                or session["audiobook"] in new_list
                            ):
                                print(
                                    "_click_gr_override_confirm_btn():  select audiobook is the converting file"
                                )
                                new_selected = None
                                if new_list:
                                    new_idx = max(0, idx - 1)
                                ...
                                if audiobook_files_state and new_selected is not None:
                                    files_update, files_state_update = (
                                        _toggle_audiobook_files(
                                            session_id, new_selected, False
                                        )
                                    )
                                else:
                                ...
                                return (
                                    gr.update(value="", visible=False),
                                    (event + 1),
                                    gr.update(choices=new_list, value=new_selected),
                                    files_update,
                                    files_state_update,
                                )
                        return (
                    ...
                    if session["status"] in [status_tags["EDIT"]]:
                        ...
                        for i in range(page_size):
                            ...
                            if idx < len(blocks):
                                ...
                                updates.append(
                                    gr.update(
                                        label=f"Block {idx}", visible=True, open=exp
                                    )
                                )
                                updates.append(gr.update(value=b["keep"]))
                                updates.append(
                                    gr.update(
                                        value=b.get("voice"), choices=voice_options
                                    )
                                )
                        ...
                        header = gr.update(
                            value=f"Blocks {start}–{end - 1} of {len(blocks) - 1}"
                        )
                        return (*updates, header, expands)

            def _navigate(
                session_id: str, page: int, blocks: list[dict], direction: int, *args
            ) -> tuple:
                    ...
                    if session and session.get("id", False):
                        if not session["cancellation_requested"]:
                            if session["status"] in [status_tags["EDIT"]]:
                                ...
                                page = max(
                                    0, min(int(blocks_current.get("page", 0)), max_page)
                                )
                                page_updates = list(
                                    _populate_page(session_id, page, blocks)
                                )
                                if session["cancellation_requested"]:
                                    visible_main = True
                                ...
                                result = (
                                    ...
                                    gr.update(visible=visible_main),
                                    gr.update(visible=visible_blocks),
                                    blocks,
                                    page,
            ...
            def _collect_page(page: int, blocks: list[dict], *args) -> list[dict]:
                ...
                for i in range(page_size):
                    ...
                    if idx < len(new_blocks):
                        new_blocks[idx]["expand"] = (
                            expands[i] if i < len(expands) else False
                        )
            ...
            def _change_current_blocks(
                session_id: str, page: int, blocks: list[dict], *args
            ) -> None:
                session = context.get_session(session_id)
                if session and session.get("id", False):
                    new_blocks = _collect_page(page, blocks, *args)
            ...
            def _click_gr_blocks_cancel_btn(
                session_id: str, page: int, blocks: list[dict], *args
            ) -> tuple:
                session = context.get_session(session_id)
                if session and session.get("id", False):
            ...
            def _click_gr_blocks_confirm_btn(
                session_id: str, event: int, page: int, blocks: list[dict], *args
            ) -> tuple:
                session = context.get_session(session_id)
                if session and session.get("id", False):
                    if session["status"] in [status_tags["EDIT"]]:
            ...
            def _change_gr_restore_session(
                data: DictProxy | None, state: dict, req: gr.Request
            ) -> tuple:
                try:
                    nonlocal models
                    ...
                    if len(active_sessions) == 0 or (
                        data and data.get("status") in (None, status_tags["READY"])
                    ):
                        restore_session_from_data(
                            data,
                            session,
                            force=bool(
                                data and data.get("status") == status_tags["READY"]
                            ),
                            filter_keys=True,
                        )
                    if not context_tracker.start_session(session["id"]):
                        ...
                        return (
                            ...
                            gr.update(),
                            gr.update(value=""),
                            _update_gr_glassmask(str=error),
                        )
                    else:
                    ...
                    if isinstance(session.get("custom_model"), str):
                        ...
                        if isinstance(custom_model_dir, str) and not os.path.exists(
                            custom_model_dir
                        ):
                            session["custom_model"] = None
                    ...
                    if session.get("translate_enabled"):
                        ...
                        if (
                            not translate_target
                            or translate_target not in language_mapping
                        ):
                    ...
                    if is_gui_shared:
                        ...
                        session["audiobooks_dir"] = os.path.join(
                            audiobooks_gradio_dir, f"web-{session['id']}"
                        )
                        ...
                        session["audiobooks_dir"] = os.path.join(
                            audiobooks_host_dir, f"web-{session['id']}"
                        )
                        delete_unused_tmp_dirs(
                            session["id"], audiobooks_host_dir, tmp_expire
                        )
                    msg += (
                        "Your browser needs cookies enabled to resume the conversions."
                    )
                        ...
                        try:
                            if session.get("ticker") != len(audiobook_options):
                                ...
                                session_filtered = {
                                    ...
                                    if k not in save_session_keys_except
                                }
                                session_dict = json.dumps(
                                    session_filtered, cls=JSONDictProxyEncoder
                                )
                                yield (
                ...
                if always:
                    return event.then(
                        fn=lambda s: (
                            ...
                            + [
                                1
                                if context.get_session(s).get("ebook_mode")
                                == ebook_modes["TEXT"]
                                else 0
                            ]
                        ),
                    ...
                    return event.then(
                        fn=lambda s: (
                            ...
                            if context.get_session(s)["status"]
                            in [status_tags["END"], status_tags["READY"]]
                            and context.get_session(s)["ebook_mode"]
                            == ebook_modes["TEXT"]
                            else (
            ...
            outputs_enable_components = [
                ...
                gr_voice_del_btn,
                gr_session_switch_btn,
                gr_blocks_cancel_btn,
                gr_blocks_confirm_btn,
                gr_custom_model_del_btn,
                gr_modal,
                gr_convert_btn,
            ]
            ...
            gr_blocks_preview.select(
                fn=lambda session_id, val: _change_param(
                    "blocks_preview", session_id, bool(val)
                ),
            ...
            gr_device.change(
                fn=_change_gr_device, inputs=[gr_session, gr_device], outputs=None
            )
            gr_language.change(
            ...
            gr_output_split_hours.change(
                fn=lambda session_id, val: _change_param(
                    "output_split_hours", session_id, str(val)
                ),
            ...
            gr_session_switch_btn.click(
                ...
                outputs=[
                    ...
                    gr_backup_session,
                    gr_session_switch_btn,
                    gr_session_switch_disable_state,
                    gr_session_switch_enable_state,
                ],
                show_progress_on=[gr_session_switch_btn],
            )
            gr_session_switch_disable_state.change(
                fn=lambda session_id: _disable_components(
                    session_id, exceptions=["gr_session_switch_btn"]
                ),
            ...
            gr_xtts_temperature.change(
                fn=lambda session_id, val: _change_param(
                    "xtts_temperature", session_id, float(val)
                ),
                inputs=[gr_session, gr_xtts_temperature],
                outputs=None,
            )
            gr_xtts_length_penalty.change(
                fn=lambda session_id, val, val2: _change_param(
                    "xtts_length_penalty", session_id, int(val), int(val2)
                ),
            ...
            gr_xtts_num_beams.change(
                fn=lambda session_id, val, val2: _change_param(
                    "xtts_num_beams", session_id, int(val), int(val2)
                ),
            ...
            gr_xtts_repetition_penalty.change(
                fn=lambda session_id, val: _change_param(
                    "xtts_repetition_penalty", session_id, float(val)
                ),
            ...
            gr_xtts_top_p.change(
                fn=lambda session_id, val: _change_param(
                    "xtts_top_p", session_id, float(val)
                ),
            ...
            gr_xtts_speed.change(
                fn=lambda session_id, val: _change_param(
                    "xtts_speed", session_id, float(val)
                ),
            ...
            gr_xtts_enable_text_splitting.select(
                fn=lambda session_id, val: _change_param(
                    "xtts_enable_text_splitting", session_id, bool(val)
                ),
            ...
            gr_bark_text_temp.change(
                fn=lambda session_id, val: _change_param(
                    "bark_text_temp", session_id, float(val)
                ),
            ...
            gr_bark_waveform_temp.change(
                fn=lambda session_id, val: _change_param(
                    "bark_waveform_temp", session_id, float(val)
                ),
            ...
            gr_qwen3_batch_size.change(
                fn=lambda session_id, val: _change_param(
                    "qwen3_batch_size", session_id, int(val)
                ),
            ...
            gr_qwen3_temperature.change(
                fn=lambda session_id, val: _change_param(
                    "qwen3_temperature", session_id, float(val)
                ),
            ...
            gr_qwen3_top_p.change(
                fn=lambda session_id, val: _change_param(
                    "qwen3_top_p", session_id, float(val)
                ),
            ...
            gr_qwen3_repetition_penalty.change(
                fn=lambda session_id, val: _change_param(
                    "qwen3_repetition_penalty", session_id, float(val)
                ),
            ...
            _chain_enable(
                _chain_check_override(
                    _chain_refresh(
                        ...
                        .then(fn=lambda: None, js=f"()=>{{{js_hide_elements}}}")
                        .then(
                        ...
                        .then(
                            fn=lambda s: (
                                gr.update(
                                    value=context.get_session(s).get("qwen3_batch_size")
                                    or 24
                                ),
                                gr.update(
                                    value=context.get_session(s).get(
                                        "qwen3_temperature"
                                    )
                                    or 0.75
                                ),
                                gr.update(
                                    value=context.get_session(s).get("qwen3_top_p")
                                    or 0.95
                                ),
                                gr.update(
                                    value=context.get_session(s).get(
                                        "qwen3_repetition_penalty"
                                    )
                                    or 2.0
                                ),
                            ),
            ...
            _chain_enable(
                gr_blocks_confirm_btn.click(
                    fn=lambda page, blocks, expands, *args: _collect_page(
                        page, blocks, expands, *args
                    ),
                    inputs=[
                        gr_blocks_page,
                        gr_blocks_data,
            ...
            _chain_enable(
                ...
                always=True,
            ).then(fn=None, inputs=None, outputs=None, js="()=>{window.load_vtt();}")
            ###########
            gr_blocks_back_btn.click(
                fn=lambda session_id, page, blocks, *args: _navigate(
                    session_id, page, blocks, -1, *args
                ),
                inputs=[
                    gr_session,
                    gr_blocks_page,
            ...
            gr_restore_session.change(
                ...
                fn=lambda session: (
                    _update_gr_glassmask(attr=["gr-glass-mask", "hide"])
                    if session
                    else gr.update()
                ),
                inputs=[gr_session],
                ...
                show_progress_on=[gr_progress],
            ).then(fn=None, inputs=None, js="()=>{window.init_interface();}")
            ...
            app.load(
                ...
                """.replace(
                    "__max_ebook_textarea_length__", str(max_ebook_textarea_length)
                ),
