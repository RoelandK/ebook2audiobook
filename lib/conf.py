...
archs = {"AMD64": "amd64", "X86_64": "x86_64", "AARCH64": "aarch64", "ARM64": "arm64"}
...
default_torchcodec_arm_url = (
    "https://github.com/ROBERT-MCDOWELL/py-pkg/releases/download"
)
...
torch_matrix = {
    # CPU
    "cpu": {
        "os": list(systems.values()),
        "arch": list(archs.values()),
        "base": "2.7.1",
        "last": "2.11.0",
        "codec": "0.11.1",
    },
    # CUDA
    "cu118": {
        "os": [systems["LINUX"], systems["WINDOWS"]],
        "arch": [archs["X86_64"], archs["AMD64"]],
        "base": "2.7.1",
        "last": "2.7.1",
        "codec": "",
    },
    ...
    "cu126": {
        "os": [systems["LINUX"], systems["WINDOWS"]],
        "arch": [archs["X86_64"], archs["AMD64"], archs["AARCH64"]],
        "base": "2.7.1",
        "last": "2.11.0",
        "codec": "0.11.1",
    },
...
default_audio_proc_format = (
    "flac"  # or 'ogg', 'wav' (wav format is ok but limited to process files < 4GB)
)
